...
?>
	<div id="top_style">
       ...
       <div id="top_style_button"> 
       		<form method="post">
            	<a href="?tag=view_users"><input type="button" name="btn_view" value="عودة"  title="عودة" id="button_view" style="width:70px;"  /></a>
...
?>
	<div id="top_style">
       ...
       <div id="top_style_button"> 
       		<form method="post">
            	<a href="?tag=view_users"><input type="button" name="btn_view" value="عرض المستخدمين"  title="عرض المستخدمين" id="button_view" style="width:120px;"  /></a>
	...
	<form method="post">
    	...
    	<table border="0" cellpadding="4" cellspacing="0" dir="rtl">
            ...
            <tr>
                <td colspan="2">
                	<input type="reset" value="الغاء" id="button-in"/>
                	<input type="submit" name="btn_sub" value="اضافة جديد" id="button-in"  />
                </td>
            </tr>
        </table>
