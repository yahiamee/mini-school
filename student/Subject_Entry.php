...
<div id="top_style">
       ...
       <div id="top_style_button"> 
       		<form method="post">
            	<a href="?tag=view_subjects" ><input type="button" name="btn_view" title="عودة" value="عودة" id="button_view" style="width:70px;"  /></a>
...
<div id="top_style">
       ...
       <div id="top_style_button"> 
       		<form method="post">
            	<a href="?tag=view_subjects" ><input type="button" name="btn_view" title="عرض المواد" value="عرض المواد" id="button_view" style="width:120px;"  /></a>
