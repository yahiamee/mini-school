...
<table width="755">
	<tr>
        ...
        <td><a href="?tag=faculties_entry"><input type="button" title="اضافة فصل جديد" name="butAdd" value="اضافة فصل" id="button-search" /></a></td>
...
<div id="content-input">
    ...
    $color=($i%2==0)?"lightblue":"white";
      ...
      <tr bgcolor="<?php echo $color?>">
            ...
            <td align="center"><a href="?tag=faculties_entry&opr=upd&rs_id=<?php echo $row['faculties_id'];?>" title="تعديل"><img src="picture/update.png" /></a></td>
            <td align="center"><a href="?tag=view_faculties&opr=del&rs_id=<?php echo $row['faculties_id'];?>" title="حذف"><img src="picture/delete.png" /></a></td>
        </tr>
    <?php	
    }
    ?>
